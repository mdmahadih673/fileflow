...
import { FileItem, OrganizationResult, FileCategory } from '../../src/types/file.js';
...
export async function organizeFiles(
  ...
  folderPath: string,
  files: FileItem[]
): Promise<{ result: OrganizationResult, moves: { source: string, destination: string }[] }> {
...
export async function undoOrganization(
